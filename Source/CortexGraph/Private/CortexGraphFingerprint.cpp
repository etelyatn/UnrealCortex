...
TSharedPtr<FJsonObject> FCortexGraphFingerprint::Compute(UBlueprint* Blueprint)
{
...
FString FCortexGraphFingerprint::ComputeGeneratedStateDigest(UBlueprint* Blueprint)
{
	if (Blueprint == nullptr)
	{
		return FString();
...
bool FCortexGraphFingerprint::ValidatePrecondition(
