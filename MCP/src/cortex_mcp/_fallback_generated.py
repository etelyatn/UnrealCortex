...
FALLBACK_COMMANDS: dict[str, list[dict]] = {   'blueprint': [   {   'name': 'create',
                     ...
                     {   'name': 'remove_graph',
                         'params': [   {'name': 'asset_path', 'required': True, 'type': 'string'},
                                       ...
                                       {'name': 'compile', 'required': True, 'type': 'boolean'},
                                       {'name': 'save', 'required': True, 'type': 'boolean'},
    ...
    'editor': [   {   'name': 'start_pie',
                  ...
                  {'name': 'get_world_info'}],
    'graph': [   {   'name': 'get_authoring_context',
                     'params': [   {'name': 'asset_path', 'required': True, 'type': 'string'},
                                   {'name': 'target', 'required': False, 'type': 'object'}]},
                 {   'name': 'list_graphs',
                     'params': [   {'name': 'asset_path', 'required': True, 'type': 'string'},
                 ...
                 {   'name': 'apply_patch',
                     'params': [   {'name': 'asset_path', 'required': True, 'type': 'string'},
                                   {'name': 'target', 'required': False, 'type': 'object'},
                                   {'name': 'patch_id', 'required': True, 'type': 'string'},
                                   {   'name': 'expected_fingerprint',
                                       'required': True,
                                       'type': 'object'},
                                   {'name': 'nodes', 'required': False, 'type': 'array'},
                                   {'name': 'connections', 'required': False, 'type': 'array'},
                                   {'name': 'pin_updates', 'required': False, 'type': 'array'},
                                   {'name': 'migration', 'required': False, 'type': 'object'},
                                   {'name': 'dry_run', 'required': False, 'type': 'boolean'},
                                   {'name': 'compile', 'required': False, 'type': 'boolean'},
                                   {'name': 'save', 'required': False, 'type': 'boolean'},
                                   {'name': 'allow_noop', 'required': False, 'type': 'boolean'},
                                   {   'name': 'expected_validation_hash',
                                       'required': False,
                                       'type': 'string'}]}],
